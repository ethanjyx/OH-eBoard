Ext.define('testapp.view.Location', {
	...
	initialize: function() {
		var position = new Microsoft.Maps.Location(testapp.app.mapCenter[0], testapp.app.mapCenter[1]),
			map;
        ...
        var mapCallback = function(){
            ...
            var infobox = new Microsoft.Maps.Infobox(position, {
                description: testapp.app.mapText, visible: true, offset: new Microsoft.Maps.Point(0, 10), height: 100,width:180
            });
