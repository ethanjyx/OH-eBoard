		    ...
		    success: function(data) {
		        ...
		        Ext.Array.each(data.proposals, function(proposal) {
		            ...
		            Ext.Array.each(proposal.speakers, function(speaker) {
		                ...
		                speakerModel = Ext.create('testapp.model.Speaker', speaker);
		        ...
		        testapp.sessionDays = Ext.Array.sort(Ext.Object.getValues(sessionDays), function(a, b) {
